...
def banner():
   ...
   """  /__/     \__\ |_______||__|      """,
    ...
    #print('=============SON OF GOD==============')
    print(f'   Version: 1.0 | Author: ALI{n}\n')
...
while True:
    ...
    if a == 1:
        ...
        try:
            # https://raw.githubusercontent.com/krish775/Ali-TG-Member-Adder/main/version.txt
            version = requests.get('https://raw.githubusercontent.com/krish775/Ali-TG-Member-Adder/main/version.txt')
        except:
        ...
        if float(version.text) > 0.9:
            ...
            if prompt == 'y' or prompt == 'yes' or prompt == 'Y':
                ...
                if os.name == 'nt':
                    os.system('del ali-adder.py')
                    os.system('del ali-manager.py')
                else:
                    os.system('rm ali-adder.py')
                    os.system('rm ali-manager.py')
                #os.system('del scraper.py')
                os.system('curl -l -O https://raw.githubusercontent.com/krish775/Ali-TG-Member-Adder/main/ali-adder.py')
                os.system('curl -l -O https://raw.githubusercontent.com/krish775/Ali-TG-Member-Adder/main/ali-manager.py')
